...
OFFICIAL_NAMES: dict[str, str] = {
    "k01": "Artisan", "k02": "Bandit", "k03": "Bureaucrat", "k04": "Cellar",
    "k05": "Chapel", "k06": "Council Room", "k07": "Festival", "k08": "Gardens",
    "k09": "Harbinger", "k10": "Laboratory", "k11": "Library", "k12": "Market",
    "k13": "Merchant", "k14": "Militia", "k15": "Mine", "k16": "Moat",
    "k17": "Moneylender", "k18": "Poacher", "k19": "Remodel", "k20": "Sentry",
    "k21": "Smithy", "k22": "Throne Room", "k23": "Vassal", "k24": "Village",
    "k25": "Witch", "k26": "Workshop", "treasure1": "Copper", "treasure2": "Silver",
    "treasure3": "Gold", "victory1": "Estate", "victory2": "Duchy",
    "victory3": "Province", "curse": "Curse",
}
...
CATALOG: dict[str, CardDefinition] = {
    key: CardDefinition(
        ...
        cost,
        frozenset(
            {"victory"} if key == "k08" else
            {"action", "attack"} if key in {"k02", "k03", "k14", "k25"} else
            {"action", "reaction"} if key == "k16" else {"action"}
        ),
    )
